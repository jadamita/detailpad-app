    ...
    function Logger(args, req, autoFlush, source, logLevel) {
        ...
        this._log = function (level, message, args) {
            ...
            if (args instanceof Error) {
                logEvent.fields = __assign(__assign({}, logEvent.fields), { message: args.message, stack: args.stack, name: args.name });
            }
            else if (typeof args === 'object' && args !== null && Object.keys(args).length > 0) {
                var parsedArgs = JSON.parse(JSON.stringify(args, jsonFriendlyErrorReplacer));
                logEvent.fields = __assign(__assign({}, logEvent.fields), parsedArgs);
            }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        fetch_1 = _a.sent();
                        fetch_1(url, reqOptions).catch(console.error);
                        return [3 /*break*/, 4];
                    case 3:
                        if (config_1.default.isBrowser && config_1.isVercel && navigator.sendBeacon) {
