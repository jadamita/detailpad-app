...
exports.withAxiomGetServerSideProps = exports.withAxiom = exports.withAxiomNextEdgeFunction = exports.withAxiomNextServerSidePropsHandler = exports.withAxiomNextApiHandler = exports.withAxiomNextConfig = void 0;
    ...
    return __assign(__assign({}, nextConfig), { rewrites: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        rewrites = _b.sent();
                        webVitalsEndpoint = config_1.default.getIngestURL(shared_1.EndpointType.webVitals);
                        logsEndpoint = config_1.default.getIngestURL(shared_1.EndpointType.logs);
                        ...
                        axiomRewrites = [
                            {
                                source: "".concat(config_1.default.proxyPath, "/web-vitals"),
                                destination: webVitalsEndpoint,
                                basePath: false,
                            },
                            {
                                source: "".concat(config_1.default.proxyPath, "/logs"),
...
function withAxiomNextApiHandler(handler) {
    ...
    return function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    report = config_1.default.generateRequestMeta(req);
...
exports.withAxiomNextApiHandler = withAxiomNextApiHandler;
function withAxiomNextServerSidePropsHandler(handler) {
    var _this = this;
    return function (context) { return __awaiter(_this, void 0, void 0, function () {
        var report, logger, axiomContext, result, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    report = config_1.default.generateRequestMeta(context.req);
                    logger = new logger_1.Logger({}, report, false, 'lambda');
                ...
                case 1:
                    _a.trys.push([1, 4, , 6]);
                    return [4 /*yield*/, handler(axiomContext)];
                case 2:
                    result = _a.sent();
                    return [4 /*yield*/, logger.flush()];
                case 3:
                ...
                case 4:
                    error_2 = _a.sent();
                    logger.error('Error in getServerSideProps handler', { error: error_2 });
                    logger.attachResponseStatus(500);
                    return [4 /*yield*/, logger.flush()];
                case 5:
                    _a.sent();
...
exports.withAxiomNextServerSidePropsHandler = withAxiomNextServerSidePropsHandler;
function withAxiomNextEdgeFunction(handler) {
    var _this = this;
    return function (req, ev) { return __awaiter(_this, void 0, void 0, function () {
        var report, logger, axiomRequest, res, error_3;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 3:
                    error_3 = _b.sent();
                    logger.error('Error in edge function', { error: error_3 });
                    logger.attachResponseStatus(500);
                    ev.waitUntil(logger.flush());
                    logEdgeReport(report);
                    throw error_3;
...
exports.withAxiomNextEdgeFunction = withAxiomNextEdgeFunction;
function logEdgeReport(report) {
    if (config_1.default.shoudSendEdgeReport) {
...
exports.withAxiomGetServerSideProps = withAxiomNextServerSidePropsHandler;
